...
const ChartCard = ({ type }) => {
  ...
  return (
    <div className="p-2 lg:p-3 w-full md:col-span-1 md:w-1/3 md:h-1/2">
      <div className="bg-white px-4 pt-1 pb-10 rounded-lg">
        <div className="mt-3 flex justify-between">
          <h3 className="text-lg text-mainColor mb-6">
            {type === "area" ? "Statistics" : "Sales Distribution"}
          </h3>
          <h3 className="text-sm text-mainColor mb-4 mt-1" >{type === "area" ? "Last 6Months" : ""}</h3>
        </div>
        <div>
          {type === "area" ? (
